    ...
    <div class="form-wrapper">
        <div class="contact-container">
            ...
            <div class="brand-header">
                ...
                <p class="form-subtitle">Vui lòng thiết lập mật khẩu mới cho tài khoản của bạn</p>
            </div>
            ...
            <form action="/dat-lai-mat-khau" method="POST">
                ...
                <div class="input-group">
                    <label class="input-label">Mật khẩu mới <span class="required-star">*</span></label>
                    <div class="input-box">
                        <i class="fa-solid fa-lock icon-left"></i>
                        <input type="password" id="new_password" name="new_password" placeholder="Nhập mật khẩu mới *" required>
                        <i class="fa-solid fa-eye toggle-password" id="toggle_new_pass" onclick="togglePasswordVisibility('new_password', 'toggle_new_pass')" title="Ẩn/Hiện mật khẩu"></i>
                    </div>
                </div>
                ...
                <div class="input-group">
                    ...
                    <div class="input-box">
                        ...
                        <i class="fa-solid fa-eye toggle-password" id="toggle_confirm_pass" onclick="togglePasswordVisibility('confirm_password', 'toggle_confirm_pass')" title="Ẩn/Hiện mật khẩu"></i>
                    </div>
                </div>
